...
<nav id="menu" style="background:url(image/navBg.png repeat-x;)">
    ...
    <div id="whole">
    <section id="sec">
    <center><b><p style="font-family: Arial, Helvetica, sans-serif;font-size: 40px;color:red;">Contacts</p></b></center>
    	<div id="cont">
        <img src="image/uploadFiles/Anku.JPG" id="mainImage" height="500" width="660">
        <div style="position:relative; top:-70px; align-content:center;"><center><h2 id="info" style="color:red; font-family:'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif">Ankit Prasad</h2>
        <h5 style="color:blue;">NSEC</h5></center>
        <h4><a href="mailto:ap6112560@gmail.com">Email & Let Us know!</a></h4>
        <div>
