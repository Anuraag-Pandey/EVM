...
<div id="whole">
    <section id="sec">
    <center><b><p style="font-family: Arial, Helvetica, sans-serif;font-size: 40px;color:red;">Add Election Details</p></b></center>
    	<div id="cont">
<%
DAO ob = new DAO();
    	...
    	%>
    <form action="reg.jsp?choice=11" method="post">
    	<input name="Electiondate" type="date" value="<%=Electiondate%>">
    	<input name="Constituency" type="text" value="<%=Constituency%>" readonly>
    	<input name="Countingdate" type="date" value="<%=Countingdate%>">
