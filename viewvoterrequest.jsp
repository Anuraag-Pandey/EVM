...
<li><a href="viewvoterrequest.jsp">Voter Request</a></li>
</ul>
</nav>
   <div id="whole">
    <section id="sec">
    <center><b><p style="font-family: Arial, Helvetica, sans-serif;font-size: 40px;color:red;">Voter Requests</p></b></center>
    	<div id="cont">
<table border="1">
<tr><td><b>Userid</b></td><td><b>Constituency</b></td><td><b>Dateofbirth proof</b></td><td><b>Address proof</b></td><td><b>Photo</b></td><td><b>Voterid</b></td><td><b>Voted</b></td></tr>
<%
ResultSet r=ob.voterrequest();
while(r.next()){
String Userid=r.getString("Userid");
String Constituency =r.getString("Constituency");
String dobd =r.getString("dobd");
String adpd =r.getString("adpd");
String Approvedstatus =r.getString("Approvedstatus");
String VoterId =r.getString("VoterId");
String Voted=r.getString("Voted");
...
<td><%=Userid%></td>
<td><%=Constituency%></td>
<td><a href="image/uploadFiles/<%=dobd%>">dobd</a></td>
<td><a href="image/uploadFiles/<%=adpd%>">adpd</a></td>
<td><img src="image/uploadFiles/<%=photo%>" height="100px" width="120px"></td>
<td><%=VoterId%></td>
<td><%=Voted%></td>
<%String a=Approvedstatus;
if (a.equals("0")){%>
<td><input type="submit" value="Add" formaction="reg.jsp?choice=10&Userid=<%=Userid%>&Constituency=<%=Constituency%>"/></td>
<%} %></tr></form>
<%
}
%>
