...
<nav id="menu" style="background:url(image/navBg.png repeat-x;)">
   ...
   <div id="whole">
    <section id="sec">
    <center><b><p style="font-family: Arial, Helvetica, sans-serif;font-size: 40px;color:red;">Candidate List</p></b></center>
    	<div id="cont">
    	<table border="1">
    	<tr><td><b>Party</b></td><td><b>Candidate</b></td><td><b>Constituency</b></td></tr>
<%
String clas=request.getParameter("clas");
ResultSet res=ob.viewcandidates(clas);
while(res.next()){%>
<form method="post">
<tr>
	...
	<%if(s.equals("0")) {%>
	<td><input type="submit" id="submit" value="Add" formaction="reg.jsp?choice=7&Partyname=<%=res.getString("Partyname")%>&Constituency=<%=res.getString("Constituency")%>&Name=<%=res.getString("Name")%>"></td>
	<%} %></tr></form>
<%}
%>
</table>
